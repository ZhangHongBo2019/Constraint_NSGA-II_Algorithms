...
for i=1:1:(modules-1)
Instances(1,i)=2+round(4*rand(1));%2-6
end
...
for i=1:1:(modules-1)
    if i==1
    time(1,1:Index(i))=2+round(10*rand(Instances(1,i),1));%2-12
    else
        time(1,(Index(i-1)+1):Index(i))=2+round(10*rand(Instances(1,i),1));
    end
end
...
for l=1:1:(modules-1)
    if l==1
    cost(1:Index(l),1)=5+round(95*rand(Instances(1,l),1));%10-100
    else
        cost((Index(l-1)+1):Index(l),1)=5+round(95*rand(Instances(1,l),1));
    end
end
for j=1:1:bb
    if time(1,j)==0.0001
...
for p=1:1:(modules-1)
    if p==1
        Performance(1:Index(p),1)=vpa(3*rand(Instances(1,p),1),5);%0-3
    else
        Performance((Index(p-1)+1):Index(p),1)=vpa(3*rand(Instances(1,p),1),5);
    end
end
for j=1:1:bb
    if time(1,j)==0.0001
