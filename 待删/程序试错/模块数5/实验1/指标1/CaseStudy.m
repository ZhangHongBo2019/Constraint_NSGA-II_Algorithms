...
for i=1:1:(modules-1)
Instances(1,i)=2+round(2*rand(1));
end
...
for i=1:1:(modules-1)
    if i==1
    time(1,1:Index(i))=1+round(4*rand(Instances(1,i),1));%1-5
    else
...
for l=1:1:(modules-1)
    if l==1
    cost(1:Index(l),1)=10+round(10*rand(Instances(1,l),1));%10-20
    else
        cost((Index(l-1)+1):Index(l),1)=10+round(10*rand(Instances(1,l),1));
    end
end
for j=1:1:bb
    if time(1,j)==0.0001
...
for p=1:1:(modules-1)
    if p==1
        Performance(1:Index(p),1)=2*rand(Instances(1,p),1);%0-2
    else
        Performance((Index(p-1)+1):Index(p),1)=2*rand(Instances(1,p),1);
    end
end
for j=1:1:bb
    if time(1,j)==0.0001
